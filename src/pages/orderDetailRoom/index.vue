    ...
    <div class="order">
        <div class="container">
            <div class="course-name">
                <img :src="orderData.class_info.pic" />
            </div>
            <div class="detail">
                <div class="teacher">
                    <div class="info">
        ...
        data() {
            return {
                ...
                orderData: {
                    ...
                    class_info:{
                        address: '徐汇区天钥桥路100号',
                        pic: 'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1506506373719&di=b6a96d91fa50aaceb2f758a69f82a854&imgtype=0&src=http%3A%2F%2Fpic28.nipic.com%2F20130417%2F5899893_104510669395_2.jpg'
                    }
                },
                pastle: false,
                message: '',
